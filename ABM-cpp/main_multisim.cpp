...
int main(int argc, char** argv) {
    ...
    // std::cout<<"here2!\n";
    init_simulation(agents, total_pop, d_IU, m, domain_limits_x, domain_limits_y, seeds_per_subSim, num_of_subSims, subSim_IDs, ms_per_subSim, savename);
    // std::cout<<"here3!\n";
    ...
    for (int step = 0; step < nsteps; ++step) {
        ...
        simulate_one_step(agents, total_pop, d_IU, del_t, jump_probs, mobilities, m, step, nsteps, num_of_subSims);
